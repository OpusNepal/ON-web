...
export class NavbarService {
  ...
  private username = new BehaviorSubject<string>(!localStorage.getItem('name')?"Hello":(localStorage.getItem('name').match(' ')?localStorage.getItem('name').split(" ")[0]:localStorage.getItem('name')));
